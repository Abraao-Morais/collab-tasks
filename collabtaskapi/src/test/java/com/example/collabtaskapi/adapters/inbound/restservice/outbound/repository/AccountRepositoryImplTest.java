package com.example.collabtaskapi.adapters.inbound.restservice.outbound.repository;

import com.example.collabtaskapi.adapters.outbound.entities.JpaAccountEntity;
import com.example.collabtaskapi.adapters.outbound.repository.AccountRepositoryImpl;
import com.example.collabtaskapi.adapters.outbound.repository.JpaAccountRepository;
...
public class AccountRepositoryImplTest {
    ...
    void shouldReturnAccountWhenIdExists() {
        ...
        Optional<Account> result = accountRepositoryImpl.findById(entity.getId());
