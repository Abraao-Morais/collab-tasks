...
public class JpaTaskEntityTest {
    ...
    public void shouldCreateEntityFromTask() {
        Account account = new Account(1, "user", "user@example.com", "userPassword", null, true); // Exemplo, adapte seu construtor
        ...
        jpaAccountEntity.setActive(account.getIsActive());
